...
@SourceType(value = "Neo4jARP", label = "Neo4j",uiConfig = "neo4j-layout.json")
public class Neo4jConf extends AbstractArpConf<Neo4jConf> {
  private static final String ARP_FILENAME = "arp/implementation/neo4j-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.neo4j.Neo4jDriver";
