...
3. Download and install the [Neo4J JDBC Driver from CData](https://www.cdata.com/drivers/neo4j/download/jdbc)* and copy the JAR file to the /jars/3rdparty/ directory of your Dremio installation. For example:
